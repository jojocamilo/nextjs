...
const SingleCard = () => {
  ...
  const handleLike = async () => {
    ...
    try {
      ...
      const likedPortfolio = JSON.parse(
        localStorage.getItem('likedPortfolio') || '[]'
      );
  ...
  return (
    <>
      {/* Header-Bereich */}
      <div
        className="slider_single-project_header"
        ...
        <div className="project-hero_container">
          <div className="portfolio-meta">
            ...
            <p className="portfolio-excerpt">
              {projectData.projectTexts?.heroParagraph || projectData.excerpt}
            </p>
                ...
                <button className="btn-view">
                  <div className="counter-info-row">
                    ...
                    >
                      ...
                      >
                        <path
                          d="M2375 3994 c-602 -63 -1116 -314 -1570 -769 -217 -217 -360 -407
                        ...
                        />
                        <path
                          d="M2395 3346 c-315 -62 -541 -285 -606 -600 -73 -352 68 -707 346 -875
          ...
          <ul className="project-info-list">
            <li className="project-info-item">
              ...
              <div className="project-info-row">
                ...
                <span className="project-info-text">
                  {projectData.projectDetails?.theme ||
            ...
            <li className="project-info-item">
              ...
              <div className="project-info-row">
                ...
                />
                <span className="project-info-text">
                  {projectData.projectDetails?.tags ||
                    projectData.tags ||
                    'HTML/CSS, JS'}
                </span>
              </div>
            ...
            <li className="project-info-item">
              ...
              <div className="project-info-row">
                ...
                />
                <span className="project-info-text">
                  {projectData.projectDetails?.date ||
                    projectData.date ||
                    '31.05.2024'}
                </span>
              </div>
          ...
          <div className="portfolio-content-block">
            <div className="portfolio-learning-grid">
              <div className="portfolio-learning-card">
                <h5 className="portfolio-learning-label">
                  Frameworks & Bibliotheken
                </h5>
                <p className="portfolio-learning-text">
                  {projectData.projectDetails?.techStack ||
              ...
              <div className="portfolio-learning-card">
                ...
                <p className="portfolio-learning-text">
                  {projectData.projectDetails?.challenges ||
                    'Building an interactive gallery with Fancybox'}
                </p>
              </div>
              <div className="portfolio-learning-card">
                <h5 className="portfolio-learning-label">
                ...
                <p className="portfolio-learning-text">
                  {projectData.projectDetails?.solutions ||
                    projectData.projectDetails?.learnings ||
                    'Implemented Fancybox with optimized lazy loading'}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="ive-demo-content">
          <div className="ive-demo-item live-demo-counter">
            ...
            <a
              href={
                projectData.demoUrl ||
                projectData.projectDetails?.demoUrl ||
                '#'
              }
              target="_blank"
          ...
          <div className="ive-demo-item github-repo-counter">
            ...
            <a
              href={
                ...
                projectData.projectDetails?.githubUrl ||
                '#'
              }
              target="_blank"
              rel="noopener noreferrer"
