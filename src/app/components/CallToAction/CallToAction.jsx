...
const CallToAction = () => {
  ...
  const handleContactClick = () => {
    window.open('https://forms.gle/ZdVX3UoB4FVaBiT2A ', '_blank');
  };
        ...
        >
          ...
          <div className="cta-header">
            ...
            <h1 className="cta-title">
              <span className="title-line">Submit your paper today!</span>
              <span className="title-line gradient">Be a part of this prestigious</span>
          ...
          <div className="cta-actions">
            <button className="primary-button" onClick={handleContactClick}>
              <span className="button-text">Submit Paper</span>
