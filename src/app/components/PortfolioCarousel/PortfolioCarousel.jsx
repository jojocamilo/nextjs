  ...
  const slides = [
    {
      ...
      title: 'CONFERENCE ACMIT',
      subtitle: 'Swiss German University',
    ...
    <>
      <section className="landing-carousel">
              ...
              >
                ...
                <div className="landing-carousel__content">
                  <div className="landing-carousel__text">
                    ...
                    {slide.eventDetails && (
                      <p className="landing-carousel__event-details">
                        {slide.eventDetails}
                      </p>
                    )}
                  </div>
        ...
        <div className="scroll-indicator">
          ...
          <span className="scroll-text">Let's Dive in!</span>
        </div>
      </section>
    </>
  );
