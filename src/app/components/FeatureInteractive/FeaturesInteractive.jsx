...
const FeaturesInteractive = () => {
  ...
  const features = [
    {
      title: '',
      highlight: 'Data Science Cyber Security',
      description:
    ...
    {
      title: '',
      highlight: 'Data Science Business Informatics',
      description:
    ...
    {
      title: '',
      highlight: 'Digital Transformation Management',
      description:
      ...
      <div className="features-container">
        ...
        <div className="section-header">
          <h2 className="section-title">
            ...
            <span className="title-accent">Topics?</span>
          </h2>
